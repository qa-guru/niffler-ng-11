...
public abstract class RestClient {
  ...
  public RestClient(String baseUrl) {
    this(baseUrl, false, JacksonConverterFactory.create(), (Interceptor) null);
  }
  ...
  public RestClient(String baseUrl, Converter.Factory factory) {
    this(baseUrl, false, factory, null);
  }

  public RestClient(String baseUrl, boolean followRedirect, Converter.Factory factory, @Nullable Interceptor... interceptors) {
